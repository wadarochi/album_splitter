...
Provide a dual-mode command-line interface: non-interactive Typer subcommands with Rich output for scripting, and an interactive Textual TUI for manual workflows.
